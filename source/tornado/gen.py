        ...
        try:
            ...
            if isinstance(result, GeneratorType):
                ...
                try:
                    ...
                    print ('mcw:5:', orig_stack_contexts)
                    yielded = next(result)
                    print('mcw:6:', yielded)
...
class Runner(object):
    ...
    def run(self):
        ...
        print ('gen.Runner.run:1', self.future, _null_future)
        ...
        try:
            ...
            while True:
                ...
                try:
                    ...
                    print('gen.Runner.run:5', self.stack_context_deactivate)
                    self.finished = True
                    self.future = _null_future
                    ...
                    # This will add callback in ioloop
                    self.result_future.set_result(_value_from_stopiteration(e))
                    self.result_future = None
                    self._deactivate_stack_context()
                    return
                except Exception:
                    print('gen.Runner.run:6')
                    self.finished = True
                    self.future = _null_future
    ...
    def handle_yield(self, yielded):
        ...
        if not self.future.done() or self.future is moment:
            print('gen.hy:7:', self.future, yielded)
